...
public:
    ...
    bool proposerRechargerPartie(Partie& partie) const;
    bool proposerSauvegarderPartie(Partie& partie) const;
    bool proposerRecommencerPartie() const;
    void abandonnerPartie(Partie& partie) const;
};